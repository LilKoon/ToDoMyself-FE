...
export const TaskDetailPopover: React.FC<TaskDetailPopoverProps> = ({
  ...
  return (
    <div
      ...
      style={positionStyle}
      className="z-30 w-[420px] max-w-[calc(100vw-32px)] bg-white dark:bg-slate-900 border border-slate-200/90 dark:border-slate-800 rounded-3xl p-5 shadow-[0_20px_50px_rgba(0,0,0,0.22)] dark:shadow-[0_20px_50px_rgba(0,0,0,0.7)] ring-1 ring-slate-900/10 dark:ring-white/10 animate-scale-up"
    >
      {/* Header Row */}
          ...
          <div className="my-1">
            <span
              className={`text-sm font-black ${
                isDueOverdue ? "text-rose-600 dark:text-rose-400" : "text-slate-900 dark:text-white"
              }`}
            >
      ...
      <div className="p-3 rounded-2xl bg-slate-50 dark:bg-slate-800/50 border border-slate-200/70 dark:border-slate-700/70 mb-3 flex items-start gap-2.5">
        ...
        <div className="flex-1 min-w-0">
          ...
          <p className="text-xs font-bold text-slate-900 dark:text-white mt-0.5 truncate">{todo.title}</p>
        </div>
      </div>
